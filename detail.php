...
<tr><td align="left" colspan="3" height="50px"><a href="enquiry.php?pid=<?php echo $data[0];   ?>"><input type="button" value="Enquiry" name="sbmt" /></a></td></tr> <br>
<tr><td align="left" colspan="3" height="50px"><a href="book.php?pid=<?php echo $data[0];   ?>"><input type="button" value="Book Now" name="sbmt" /></a></td></tr>
</table>
</td>
</tr>
</table>
