...
<tr><td class="toptd">View Booking</td></tr>
...
<td style="font-size:15px; padding:5px; font-weight:bold;">fname</td>
<td style="font-size:15px; padding:5px; font-weight:bold;">lname</td>
...
<td style="font-size:15px; padding:5px; font-weight:bold;">no. of Childs</td>
<td style="font-size:15px; padding:5px; font-weight:bold;">Estimated Amount</td>
<td style="font-size:15px; padding:5px; font-weight:bold;">Instruction</td>
<td style="font-size:15px; padding:5px; font-weight:bold;">Status Field</td></tr>


<?php

$s="select * from book,package where book.Packageid=package.Packid";
